...
export default function AddBoard({
  ...
  return (
    <div>
      ...
      {adding && (
        <>
          <div onClick={() => setAdding(false)} className="fixed top-0 right-0 bottom-0 w-full bg-dark-grey/50 dark:bg-very-dark-grey/70 grid place-items-center px-6 text-start z-10">
